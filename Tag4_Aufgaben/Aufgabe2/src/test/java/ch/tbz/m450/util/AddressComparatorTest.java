...
class AddressComparatorTest {
    ...
    void testCompareIdenticalAddresses() {
        ...
        Address address2 = new Address(2, "John", "Doe", "123-456-7890", testDate);
        
        int result = comparator.compare(address1, address2);
        
        assertEquals(0, result, "Identical addresses should return 0");
    }
    ...
    void testNullFirstname() {
        ...
        Address address3 = new Address(3, null, "Smith", "123-456-7890", testDate);
        ...
        assertEquals(0, comparator.compare(address1, address3), "Both null firstnames with same phone should return 0");
    }
    ...
    @Test
    @DisplayName("Should compare by phone number when names are identical")
    void testCompareByPhoneNumber() {
        Address address1 = new Address(1, "John", "Smith", "555-123-4567", testDate);
        Address address2 = new Address(2, "John", "Smith", "123-456-7890", testDate);
        
        int result = comparator.compare(address1, address2);
        
        assertTrue(result > 0, "555-123-4567 should come after 123-456-7890");
    }
    
    @Test
    @DisplayName("Should handle null phone numbers")
    void testNullPhoneNumbers() {
        Address address1 = new Address(1, "John", "Smith", null, testDate);
        Address address2 = new Address(2, "John", "Smith", "123-456-7890", testDate);
        Address address3 = new Address(3, "John", "Smith", null, testDate);
        
        assertTrue(comparator.compare(address1, address2) < 0, "Null phone should come before non-null phone");
        assertEquals(0, comparator.compare(address1, address3), "Both null phones should return 0");
    }
    
    @Test
    @DisplayName("Should compare by registration date when all other fields are identical")
    void testCompareByRegistrationDate() throws InterruptedException {
        Date earlierDate = new Date(System.currentTimeMillis() - 1000);
        Date laterDate = new Date(System.currentTimeMillis());
        
        Address address1 = new Address(1, "John", "Smith", "123-456-7890", earlierDate);
        Address address2 = new Address(2, "John", "Smith", "123-456-7890", laterDate);
        
        int result = comparator.compare(address1, address2);
        
        assertTrue(result < 0, "Earlier date should come before later date");
    }
    
    @Test
    @DisplayName("Should handle null registration dates")
    void testNullRegistrationDates() {
        Address address1 = new Address(1, "John", "Smith", "123-456-7890", null);
        Address address2 = new Address(2, "John", "Smith", "123-456-7890", testDate);
        Address address3 = new Address(3, "John", "Smith", "123-456-7890", null);
        
        assertTrue(comparator.compare(address1, address2) < 0, "Null date should come before non-null date");
        assertEquals(0, comparator.compare(address1, address3), "Both null dates should return 0");
    }
    
    @Test
    @DisplayName("Should sort by all attributes in priority order")
    void testCompleteAttributeComparison() throws InterruptedException {
        Date earlierDate = new Date(System.currentTimeMillis() - 2000);
        Date laterDate = new Date(System.currentTimeMillis() - 1000);
        
        Address address1 = new Address(1, "Alice", "Smith", "555-0001", earlierDate);
        Address address2 = new Address(2, "Alice", "Smith", "555-0002", laterDate);
        Address address3 = new Address(3, "Bob", "Smith", "555-0001", laterDate);
        Address address4 = new Address(4, "Alice", "Jones", "555-0003", laterDate);
        
        List<Address> addresses = Arrays.asList(address1, address2, address3, address4);
        Collections.sort(addresses, comparator);
        
        assertEquals("Jones", addresses.get(0).getLastname(), "Jones should be first (lastname priority)");
        assertEquals("555-0001", addresses.get(1).getPhonenumber(), "Alice Smith 555-0001 should be second (phone priority)");
        assertEquals("555-0002", addresses.get(2).getPhonenumber(), "Alice Smith 555-0002 should be third (phone priority)");
        assertEquals("Bob", addresses.get(3).getFirstname(), "Bob Smith should be last (firstname priority)");
    }
    
    @Test
    @DisplayName("Should return 0 when all attributes are identical")
    void testCompletelyIdenticalAddresses() {
        Address address1 = new Address(1, "John", "Smith", "123-456-7890", testDate);
        Address address2 = new Address(2, "John", "Smith", "123-456-7890", testDate);
        
        int result = comparator.compare(address1, address2);
        
        assertEquals(0, result, "Completely identical addresses should return 0");
    }
}